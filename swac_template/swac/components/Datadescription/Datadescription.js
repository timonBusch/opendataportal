...
class Datadescription extends Component {
    ...
    constructor(options = {}) {
        super(options);
        this.componentName = 'Datadescription';
...
// Options for setting event handlers
    ...
    getDescribedDataset(data, visuDataset = null) {
        ...
        if (visuDataset === null && this.options.visuDataset) {
            ...
            SWAC_debug.addDebugMessage('datadescription', 'There was nor a visuDataset or a datadescription_options.visuDataset option set. Will use whole given data');
            return data;
            ...
            SWAC_debug.addDebugMessage('datadescription', msg);
            return [];
        } else if (visuDataset !== null) {
    ...
    getDescribedValue(dataset, visuAttribute = null) {
        ...
        if (typeof dataset === 'object') {
            if (dataset[visuAttribute]) {
                ...
                SWAC_debug.addDebugMessage('datadescription', msg, this.requestor);
            }
        } else {
            return dataset;
        }
    ...
    getVocable(data, visuDataset = null, visuAttribute = null) {
        ...
        if (typeof legenddata[visuAttribute] === 'undefined'
            ...
            SWAC_debug.addDebugMessage('datadescription', 'There is no ' + visuAttribute + '.values with description information in the data.');
        } else if (typeof legenddata[visuAttribute].values[value].txt !== 'undefined') {
            return legenddata[visuAttribute].values[value].txt;
        } else {
            SWAC_debug.addDebugMessage('datadescription', 'For value >' + value + '< in >' + visuAttribute + '< is no vocable defined.');
        }
        return null;
    }
...
//        }
        ...
        if (typeof legenddate[visuAttribute] === 'undefined'
            ...
            if (!this.msged_normedValues.has(visuAttribute)) {
                SWAC_debug.addDebugMessage('datadescription', 'There are no >' + visuAttribute + '.minValue< or >' + visuAttribute + '.maxValue<.');
    ...
    getScaledValue(data, visuDataset = null, visuAttribute = null) {
        ...
        if (!legenddata[visuAttribute] || !legenddata[visuAttribute].scale) {
            SWAC_debug.addDebugMessage('Datadescription', 'There is no >' + visuAttribute + '.scale< defined');
            return value;
        } else {
    ...
    getAttributeColor(visuAttribute = null) {
        ...
        if (typeof legenddata[visuAttribute] !== 'undefined'
            ...
            SWAC_debug.addDebugMessage('datadescription', 'Get color for attribute name >' + visuAttribute + '<');
    ...
    getValueVisData(data, visdataname, visuDataset = null, visuAttribute = null) {
        ...
        if (!visuAttribute || visuAttribute === null) {
            SWAC_debug.addDebugMessage('datadescription', 'Do not know which attribute should be visualised options.visuAttribute is not set.');
            return null;
        }

        if (!visdataname || visdataname === null) {
            SWAC_debug.addErrorMessage('datadescription', 'Do not know which attribute should be used from >' + visuAttribute + '<');
            return null;
        }
        ...
        if (!value || value === null) {
            SWAC_debug.addDebugMessage('Datadescription', 'There is no value for attribute >' + visuAttribute + '<.', this.requestor);
            return null;
        }

        let legenddata = this.data[this.options.activeSource][this.options.activeSet];
        if (typeof legenddata[visuAttribute] === 'undefined') {
            SWAC_debug.addDebugMessage('Datadescription', 'There is no visudata for attribute >' + visuAttribute + '<', this.requestor);
            return null;
        } else if (!legenddata[visuAttribute].values) {
            if (!this.msged_nodescValues.has(visuAttribute)) {
                SWAC_debug.addDebugMessage('Datadescription', 'There is no >'
        ...
        if (!calcMode || calcMode === '=') {
            if (!legenddata[visuAttribute].values[value]) {
                if (!this.msged_nodescValue.has(value)) {
                    SWAC_debug.addDebugMessage('Datadescription',
            ...
            SWAC_debug.addDebugMessage('Datadescription', 'Calculation mode >' + visuAttribute + '.calcmode = "' + calcMode + '< is not supported.');
        }
    ...
    getAttributeMinValue(visuAttribute = null) {
        ...
        if (typeof legenddata[visuAttribute] !== 'undefined'
            ...
            SWAC_debug.addDebugMessage('datadescription', 'Get minValue for attribute name >' + visuAttribute + '<');
            return legenddata[visuAttribute].minValue;
        } else {
            SWAC_debug.addDebugMessage('Datadescription', 'Could not get minValue for attribute >' + visuAttribute + '<');
            return null;
    }
    }
    ...
    getAttributeMaxValue(visuAttribute = null) {
        ...
        if (typeof legenddata[visuAttribute] !== 'undefined'
            ...
            SWAC_debug.addDebugMessage('datadescription', 'Get maxValue for attribute name >' + visuAttribute + '<');
            return legenddata[visuAttribute].maxValue;
        } else {
            SWAC_debug.addDebugMessage('Datadescription', 'Could not get maxValue for attribute >' + visuAttribute + '<');
            return null;
    }
    }
    ...
    getMinDefinition(visuAttribute = this.options.visuAttribute) {
        ...
        if (typeof legenddata[visuAttribute] !== 'undefined'
                && typeof legenddata[visuAttribute].values !== 'undefined') {
            SWAC_debug.addDebugMessage('datadescription', 'Get minimum description definition of attribute name >' + visuAttribute + '<');
            let defValues = [];
    ...
    getMaxDefinition(visuAttribute = null) {
        ...
        if (typeof legenddata[visuAttribute] !== 'undefined'
                && typeof legenddata[visuAttribute].values !== 'undefined') {
            SWAC_debug.addDebugMessage('datadescription', 'Get maximum description definition of attribute name >' + visuAttribute + '<');
            let defValues = [];
            for (let curAttr in legenddata[visuAttribute].values) {
                defValues.push(curAttr);
            }
