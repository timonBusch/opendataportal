...
var EventsFactory = {};
EventsFactory.create = function (config) {
...
class Events extends Component {
    ...
    buildMonthControl() {
        ...
        for (let curMonthElem of monthElems) {
            curMonthElem.innerHTML = SWAC_language.Events['month_' + this.shownMonth];
        }
    }
    ...
    cloneEventsToDates() {
        ...
        for (let curEventNode of eventNodes) {
            ...
            // Get setid from node
            let setname = eventClone.getAttribute('swac_setname');
            // Exclude template
            if (setname) {
                let setid = eventClone.getAttribute('swac_setid');
                let eventdata = this.data[setname][setid];
    ...
    formatDates() {
        ...
        for (let curEventElem of eventElems) {
            ...
            if (curDateElems) {
                let setname = curEventElem.getAttribute('swac_setname');
