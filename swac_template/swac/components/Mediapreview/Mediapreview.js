...
class Mediapreview extends Component {
    ...
    constructor(options = {}) {
        super(options);
        this.componentName = 'Mediapreview';
    ...
    toggleMediaEditorButtons() {
        ...
        if (this.options.onClickMediaEdit) {
            SWAC_debug.addDebugMessage('Mediapreview', 'Mediaeditor is set. Activateing edit buttons.');
            ...
            SWAC_debug.addDebugMessage('Mediapreview', 'Mediaeditor is not set. Deactivateing edit buttons.');
            for (let curMeButton of mediaeditorButtons) {
    ...
    createPreview(set) {
        ...
        if (mediaarea === null) {
            SWAC_debug.addErrorMessage('Mediapreview', 'Repeated element for set >' + set.id + '< not found.', this.requestor);
            return null;
        }
...
//        } else {
//            SWAC_debug.addErrorMessage('Mediapreview',
    ...
    buildFilter() {
        ...
        for (let filter in this.filters) {
            if (this.filters[filter].size === 1) {
                ...
                SWAC_debug.addDebugMessage('Mediapreview', 'No filter option for >' + filter + '< because every set has the same value');
            }
        }
