 ...
 * medias and objects.
 */
var objectreferenceFactory = {};
objectreferenceFactory.create = function (pluginconfig) {
    return new ObjectreferenceSPL(pluginconfig);
};

class ObjectreferneceSPL extends ComponentPlugin {

    constructor(pluginconf) {
        super(pluginconf);
        this.componentName = 'mediaeditor/plugins/objectrefernece';
