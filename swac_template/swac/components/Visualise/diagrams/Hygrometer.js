 ...
 * @class Meter
 * 
 * creates the Meter diagram
 * 
 */
class Hygrometer extends Diagram {
     ...
     */
    drawSetDiagram(set) {
        SWAC_debug.addErrorMessage('Diagram', 'Hygrometer does not support visualising datasets.');
    }
...
diagram_types['Hygrometer'] = Hygrometer;