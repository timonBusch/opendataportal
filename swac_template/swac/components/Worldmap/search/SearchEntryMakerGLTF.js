...
class SearchEntryMakerGLTF extends SearchEntryMaker {
    ...
    isApplicable(searchResult) {
        ...
        SWAC_debug.addDebugMessage('SearchEntryMakerGLTF', 'Result with file >' + searchResult.url + '< is not renderable with this maker.');
        return false;
    }
    ...
    make(searchResults, resultNo, placeElement) {
        ...
        if (!metaFileAvailable) {
            ...
            warningElem.setAttribute('uk-tooltip', 'title: ' + SWAC_language.Worldmap.no_grounddata);
