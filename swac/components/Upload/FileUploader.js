...
class FileUploader {
    ...
    uploadFiles(files, targetURL, targetVar) {
        ...
        return new Promise((resolve, reject) => {
            let uploadPromises = [];
            SWAC_debug.addDebugMessage('FileUploader', 'Uploading ' + files.length + ' files.', thisRef.component.requestor);
            ...
            Promise.all(uploadPromises).then(
                    function (allData) {
                        SWAC_debug.addDebugMessage('FileUploader', 'All files succsessfully uploaded.', thisRef.component.requestor);
                        resolve(allData);
                    }).catch(
                    function (error) {
                        SWAC_debug.addErrorMessage('FileUploader', 'Could not upload files: ' + error, thisRef.component.requestor);
                        reject(error);
                    }
            );
        });
    ...
    uploadFile(file, targetURL, targetVar) {
        ...
        return new Promise((resolve, reject) => {
            ...
            SWAC_debug.addDebugMessage('FileUploader', 'Now uploading file >'
            ...
            if (SWAC_config.debugmode) {
                ...
                SWAC_debug.addDebugContent(thisRef.component.requestor, tmpfileElem);
            ...
            fetch(targetURL, {
                ...
                body: formData
                    ...
                    .then(data => {
                        SWAC_debug.addDebugMessage('FileUploader',
                    ...
                    .catch(error => {
                        SWAC_debug.addErrorMessage('FileUploader',
