var LoadingbarFactory = {};
LoadingbarFactory.create = function (config) {
    return new Loadingbar(config);
};

/**
 * Component to make loading bar settings
 */
class Loadingbar extends Component {

    constructor(options = {}) {
        super(options);
        this.componentName = 'Loadingbar';
    ...
    init() {
        return new Promise((resolve, reject) => {
            ...
            if (this.options.max !== null) {
                ...
                SWAC_debug.addErrorMessage('Loadingbar', 'The option max is missing.', this.requestor);
                reject();
            }
        });
    }
