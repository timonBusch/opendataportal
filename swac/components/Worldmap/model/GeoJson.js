    ...
    load(filepath) {
        ...
        return new Promise((resolve, reject) => {
            super.loadJson(filepath).then(function () {
                ...
                SWAC_debug.addErrorMessage('GeoJson', 'Error occured while loading >'
                        + filepath + '< ' + error);
                reject();
            });
        });
                ...
                clampToGround: false
                    ...
                    function (dataSource) {
                        ...
                        if (model.options.datadescription) {
                            ...
                            SWAC_debug.addDebugMessage('GeoJson', 'There is no description component bound and no visoptions set. Model will be colored with default values.');
                        }
