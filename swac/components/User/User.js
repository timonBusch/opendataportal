    ...
    init() {
        return new Promise((resolve, reject) => {
            ...
            if (!this.options.loginurl) {
                ...
                SWAC_debug.addDebugMessage('User',
    ...
    performLogin(evt) {
        ...
        remoteHandler.fetchPost(this.options.loginurl, logindata, true).then(function (userdata) {
            try {
                ...
                thisRef.showUser();
                SWAC_debug.addErrorMessage('User', 'Error occured after login: ' + error, thisRef.requestor);
            }
        ...
        if (user) {
            ...
            if (this.options.logouturl) {
                ...
                remoteHandler.fetchGet(this.options.logouturl, logoutdata).then(function (response) {
                    ...
                    SWAC_debug.addErrorMessage('User', 'Could not logout user on backend: ' + error, thisRef.requestor);
                    this.localLogout();
                });
            } else {
                this.localLogout();
