...
class SearchEntryMakerTable extends SearchEntryMaker {
    ...
    isApplicable(searchResult, resultElem) {
        ...
        if (!resultTable) {
            SWAC_debug.addDebugMessage('SearchEntryMakerTable', 'This resultEntryMaker can not be applied because there is no table in the template.');
            return false;
        }
        return true;
    }
    ...
    make(searchResults, resultNo, placeElement) {
        ...
        if (!resultTable) {
            SWAC_debug.addErrorMessage('SearchEntryMakerTable', 'There was no table found in template part for results.');
            return;
        }
        // Create table head
