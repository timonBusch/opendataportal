...
class SearchProviderFile extends SearchProvider {
    ...
    search(searchExpr, searchurl, searchcomp) {
        SWAC_debug.addDebugMessage('SearchProviderFile','Now searching on >' + searchurl + '<',searchcomp);
        ...
        return new Promise((resolve, reject) => {
            ...
            if (searchcomp.searchFor !== searchExpr) {
                SWAC_debug.addDebugMessage('SearchProviderFile', 'SearchProviderFile: >' + searchExpr + '< is no longer searched.');
                resolve();
                return;
            }
