...
class Colorcalculations {
    ...
    static rgbaToHex(rgbacol) {
        ...
        if (rgbacol.startsWith('0x')
            ...
            SWAC_debug.rgbaToHex('Colorcalculation', 'The given color >' + rgbacol + '< is no RGBA color.');
        }
        return hexcol;
    }
    ...
    static hexToRGB(hexcol) {
        ...
        if (hexcol.startsWith('#')) {
            ...
            SWAC_debug.rgbaToHex('Colorcalculation', 'The given color >' + hexcol + '< is no hexadecimal color.');
        }
        return rgbcol;
    }
